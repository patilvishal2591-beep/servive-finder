# Generated by Django 4.2.26 on 2025-11-12 12:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability_hours', models.CharField(blank=True, help_text='e.g., Mon-Fri 9AM-5PM', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_unit', models.CharField(choices=[('hour', 'Per Hour'), ('job', 'Per Job'), ('day', 'Per Day')], default='hour', max_length=20)),
                ('estimated_duration', models.CharField(blank=True, help_text='e.g., 2-3 hours', max_length=50, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usermgmt.servicecategory')),
